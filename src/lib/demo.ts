...
export function demoEvents(): Telemetry[] {
  ...
  return [
    ...
    ...["แยกศาลากลาง", "แยกสถานี", "แยกสวนเมือง"].map((name, i): Telemetry => ({ ...base(`TR-${i + 1}`, name, name, i === 2 ? "warning" : "normal"), system: "traffic", data: { signal: (["green", "red", "yellow"] as const)[i], waitSeconds: [18, 42, 9][i], mode: i === 2 ? "fixed" : "adaptive", incident: i === 2 ? "สัญญาณขัดข้องชั่วคราว" : null } })),

...
export function demoEvents(): Telemetry[] {
  ...
  return [
    ...
    ...["สี่แยกกลางอัสสัมชัญ", "แยกสถานี", "แยกสวนเมือง"].map((name, i): Telemetry => ({ ...base(`TR-${i + 1}`, name, name, i === 2 ? "warning" : "normal"), system: "traffic", data: { signal: (["green", "red", "yellow"] as const)[i], nSignal: i === 0 ? "green" : "red", eSignal: i === 1 ? "green" : "red", sSignal: "red", wSignal: i === 2 ? "yellow" : "red", activeDirection: i === 0 ? "ทิศเหนือ (North - N)" : i === 1 ? "ทิศตะวันออก (East - E)" : "ทิศตะวันตก (West - W)", waitSeconds: [4, 8, 2][i], mode: i === 2 ? "fixed" : "adaptive", incident: i === 2 ? "สัญญาณขัดข้องชั่วคราว" : null } })),
